...
@Component({
  selector: 'app-spreedsheetsexcel',
  templateUrl: './spreedsheetsexcel.component.html',
  styleUrls: ['./spreedsheetsexcel.component.css']
})
export class SpreedsheetsexcelComponent {
